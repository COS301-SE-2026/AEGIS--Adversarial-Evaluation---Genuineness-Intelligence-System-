      ...
      <div className="flex items-center gap-10">
        ...
        <div className="flex items-center gap-8">
          ...
          <div className="relative group">
            <button className="flex items-center gap-1 font-jetbrains-mono text-sm tracking-widest uppercase text-white-smoke hover:text-system-red transition-colors duration-200 cursor-pointer">
              Resources
            ...
            <div className="absolute top-full left-0 mt-2 w-48 bg-secondary-surface border border-tertiary-surface hidden group-hover:flex flex-col z-50">
              <Link
                href="/resources/docs"
                className="font-jetbrains-mono text-xs tracking-widest uppercase text-white-smoke hover:bg-tertiary-surface hover:text-system-red px-4 py-3 transition-colors duration-200"
              >
              Docs
              </Link>
              <Link
