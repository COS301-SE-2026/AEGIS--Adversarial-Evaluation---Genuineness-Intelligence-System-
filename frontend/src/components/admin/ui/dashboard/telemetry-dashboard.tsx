        ...
        <div className="space-y-6">
            ...
            <div>
                ...
                <div className="flex h-3 w-full bg-tertiary-surface rounded-full overflow-hidden mb-4">
                    <div className="h-full bg-status-warning transition-all duration-300" style={{ width: `${pastePercentage}%` }}/>
                    <div className="h-full bg-status-success transition-all duration-300" style={{ width: `${100 - pastePercentage}%` }}/>
                ...
                <div className="grid grid-cols-2 gap-3 text-center">
                    <div className="bg-background rounded p-2">
                        ...
                        <p className="text-sm font-bold font-jetbrains-mono text-status-warning">{metrics.paste_char_count}</p>
                    </div>
                    <div className="bg-background rounded p-2">
                        <p className="text-xs text-default-border">Typed</p>
                        <p className="text-sm font-bold font-jetbrains-mono text-status-success">{metrics.copy_char_count}</p>
                    </div>
                </div>
            </div>

            <div>
                <h5 className="text-sm tracking-widest text-default-text/90 mb-3">
                ...
                <div className="space-y-3">
                    <div>
                        <div className="flex justify-between text-xs mb-1">
                            ...
                            <span className="font-jetbrains-mono text-status-success">{formatMs(metrics.active_time_ms)}</span>
                        </div>
                        <div className="h-2 bg-tertiary-surface rounded-full overflow-hidden">
                            <div className="h-full bg-status-success" style={{ width: "100%" }}/>
                        </div>
                    </div>
                    <div>
                        <div className="flex justify-between text-xs mb-1">
                            <span className="text-default-border">Focus Loss</span>
                            <span className="font-jetbrains-mono text-system-red">{formatMs(metrics.focus_loss_time_ms)} ({metrics.focus_loss_count} events)</span>
                        </div>
                        <div className="h-2 bg-tertiary-surface rounded-full overflow-hidden">
            ...
            <div>
                <h5 className="text-sm  tracking-widest text-default-text/90 mb-3">Editing Activity</h5>
